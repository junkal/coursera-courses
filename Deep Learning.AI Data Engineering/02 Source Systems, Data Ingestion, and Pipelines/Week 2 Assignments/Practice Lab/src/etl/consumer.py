            ...
            try:
                ...
                for record in records_response["Records"]:
                    ...
                    try:
                        ...
                        user_session["processing_timestamp"] = datetime.datetime.now()
                        ...
                        for product in user_session["browse_history"]:
                            ...
                            overall_product_quantity += int(product["quantity"])

                            # Instructions are in the step 2.2.6.
                            if product["in_shopping_cart"] == True:
                                overall_in_shopping_cart += int(product["quantity"])
                        ...
                        response = kinesis.put_record(
                            ...
                            else kinesis_dest_stream_names["International"],
                    ### END CODE HERE ###
                            Data=json.dumps(
